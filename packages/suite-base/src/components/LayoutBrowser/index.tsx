            ...
            <List className={classes.actionList} disablePadding>
              <ListItem disablePadding>
                <ListItemButton onClick={createNewLayout}>
                  <ListItemText disableTypography>{t("workspace:createNewLayout").toString()}</ListItemText>
                </ListItemButton>
              </ListItem>
              <ListItem disablePadding>
                <ListItemButton onClick={importLayout}>
                  <ListItemText disableTypography>{t("workspace:importFromFile").toString()}</ListItemText>
                </ListItemButton>
              </ListItem>
            </List>
